//UIUC CS125 SPRING 2014 MP. File: MolecularSort.java, CS125 Project: Challenge7-RecursiveKnight, Version: 2014-04-11T09:33:42-0500.688996000
/**
 * 
 * @author yangeng2
 *
...
public class MolecularSort {
	...
	static int findIndexOfZMinimum(double[][] coords, int lo, int hi) {
		...
		if(coords[result][2] < coords[lo][2]){
			return result;
		}
